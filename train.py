...
from model import (build_etog_segmenter_res, build_etog_segmenter_vit)
...
def get_parser():
    ...
    #change parser config everytime for training and testing
    parser.add_argument('--config',
                        type=str,
                        default='config/refcoco/bridge_r50.yaml',
                        help='config file')
